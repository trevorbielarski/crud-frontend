...
class ListAlbumComponent extends Component {
    ...
    viewAlbum(id) {
        this.props.history.push(`/crud-frontend-app/view-album/${id}`); 
    }

    addAlbum() {
        this.props.history.push('/crud-frontend-app/add-album/_add'); 
    }

    editAlbum(id) { // EDITING ALBUM BY ID??? 
        this.props.history.push(`/crud-frontend-app/add-album/${id}`); 
    }
